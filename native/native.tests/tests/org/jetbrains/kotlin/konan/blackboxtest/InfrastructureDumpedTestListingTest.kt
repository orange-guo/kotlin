...
class InfrastructureDumpedTestListingTest : AbstractNativeStandaloneTest() {
    @Test
    ...
    private fun doTest(@TestDataFile testDataPath: String, fromSources: Boolean) = with(helper) {
