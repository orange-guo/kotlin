...
class Fir2IrResultsConverter(
    ...
    override fun transform(
        ...
        val resultParts = mutableListOf<JvmIrCodegenFactory.JvmIrBackendInput>()

        for (firOutputPart in inputArtifact.partsForDependsOnModules) {
            ...
            val (irModuleFragment, components) = firOutputPart.firAnalyzerFacade.convertToIr(fir2IrExtensions, dependentComponents)
