...
class KlibMetadataClassDataFinder(
    ...
    private val deserializedContainerSource: DeserializedContainerSource? = null
) : ClassDataFinder {
    ...
    override fun findClassData(classId: ClassId): ClassData? {
        ...
        return ClassData(nameResolver, foundClass, KlibMetadataVersion.INSTANCE, deserializedContainerSource ?: SourceElement.NO_SOURCE)
    }
}
