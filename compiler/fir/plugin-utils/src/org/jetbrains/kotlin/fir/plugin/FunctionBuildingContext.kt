...
sealed class FunctionBuildingContext<T : FirFunction>(
    ...
    protected val valueParameters = mutableListOf<ValueParameterData>()
    ...
    fun valueParameter(
        ...
        valueParameters += ValueParameterData(name, type, isCrossinline, isNoinline, isVararg, hasDefaultValue, key)
    }
