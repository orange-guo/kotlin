...
fun createMemberFunction(
    ...
    return createMemberFunction(owner, key, name, { returnType }, extensionReceiverType, contextReceiverTypes, config)
}
...
fun createMemberFunction(
    ...
    return SimpleFunctionBuildingContext(
        session, key, owner, callableId, returnTypeProvider,
...
fun createTopLevelFunction(
    ...
    return createTopLevelFunction(key, packageName, name, { returnType }, extensionReceiverType, contextReceiverTypes, config)
}
...
fun createTopLevelFunction(
    ...
    return createTopLevelFunction(key, CallableId(packageName, name), returnTypeProvider, extensionReceiverType, contextReceiverTypes, config)
}
...
fun createTopLevelFunction(
    ...
    return createTopLevelFunction(key, callableId, { returnType }, extensionReceiverType, contextReceiverTypes, config)
}
...
fun createTopLevelFunction(
    ...
    return SimpleFunctionBuildingContext(
        session, key, owner = null, callableId, returnTypeProvider,
        extensionReceiverType, contextReceiverTypes
    ).apply(config).build()
}
