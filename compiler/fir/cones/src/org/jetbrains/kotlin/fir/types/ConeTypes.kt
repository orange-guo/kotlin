        ...
        fun create(
            ...
            val lowerBoundToUse = if (!lowerBound.attributes.contains(CompilerConeAttributes.RawType)) {
                ConeClassLikeTypeImpl(
                    lowerBound.lookupTag, lowerBound.typeArguments, lowerBound.isNullable, lowerBound.attributes.add(
                        ConeAttributes.create(listOf(CompilerConeAttributes.RawType))
                    )
                )
            } else {
                lowerBound
