...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(DEPRECATED_RESOLVE_TO_ENUM_ENTRIES, "Access to enum entry ''{1}'' is deprecated because synthetic property ''{0}'' is available. Please rename enum entry", FQ_NAME, FQ_NAME);
        MAP.put(DEPRECATED_RESOLVE_TO_ENUM_ENTRIES_PROPERTY, "Access to enum property ''{1}'' is deprecated because synthetic property ''{0}'' is available. Please rename enum entry", FQ_NAME, FQ_NAME);
