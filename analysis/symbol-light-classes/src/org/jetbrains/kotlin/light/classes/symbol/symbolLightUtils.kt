...
private fun KtKClassAnnotationValue.toAnnotationMemberValue(parent: PsiElement): PsiExpression? {
    val typeString = when (this) {
        ...
        is KtKClassAnnotationValue.KtLocalKClassAnnotationValue -> return null
        is KtKClassAnnotationValue.KtErrorClassAnnotationValue -> unresolvedQualifierName ?: return null
    }
