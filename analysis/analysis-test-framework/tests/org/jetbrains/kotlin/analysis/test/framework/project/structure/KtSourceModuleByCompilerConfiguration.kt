...
abstract class KtModuleByCompilerConfiguration(
    ...
    val allDependsOnDependencies: List<KtModule> by lazy { computeTransitiveDependsOnDependencies(directDependsOnDependencies) }
...
private class LibraryByRoots(
    ...
    override val allDependsOnDependencies: List<KtModule> get() = emptyList()
